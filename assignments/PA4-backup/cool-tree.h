...
class Feature_class : public tree_node {
   public:
    ...
    virtual void check_scope_and_type(SymbolTableP symbol_table, ClassTableP class_table) = 0;
...
class program_class : public Program_class {
   ...
   public:
    ...
    void check_scope_and_type(SymbolTableP symbol_table, ClassTableP class_table);
